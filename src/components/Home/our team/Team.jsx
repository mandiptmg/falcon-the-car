      ...
      <div className='md:w-[80vw] mx-auto max-w-7xl w-[90vw]'>
        ...
        <div className='my-10 '>
          <iframe
            ...
            loading='lazy'
            className='filter-hue-rotate-180 duration'
          ></iframe>
        </div>
      </div>
      <div className='mt-20 p-6 text-white bg-black/80 bg-[url(https://c4.wallpaperflare.com/wallpaper/404/19/616/dark-car-vehicle-ford-wallpaper-preview.jpg)] bg-no-repeat bg-cover  object-cover bg-blend-overlay bg-center md:px-14 md:py-6 flex justify-between items-center'>
        ...
        <div
          data-aos='fade-left'
          className='bg-white rounded  text-sky-400 md:px-4 md:py-2 p-1 text-xs md:text-base  '
        >
          <NavLink to='/contact'>
