      ...
      <div className='text-center py-16 space-y-7'>
        ...
        >
          ...
          <div className='grid space-y-4 text-center place-items-center'>
            ...
            <p className='text-sm text-gray-500'>
              Select car rental pickup date for your convenience and an
              enjoyable travel experience ahead.
            </p>
          </div>
          <div className='grid space-y-4 text-center place-items-center'>
            <img
            ...
            <p className='text-sm text-gray-500'>
              Secure your car rental today! Book now for a seamless experience
              in reliable and comfortable vehicles. Drive with confidence
            </p>
          </div>
        </div>
